...
<div class="auto-style1">
    ...
    <table class='table table-hover table-responsive table-bordered'>
        ...
        <tr>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ASPCRUDConnectionString %>" SelectCommand="SELECT [Organisation], [ContractAmount], [AmountPaid],
